...
<TMPL_ELSE>
  ...
  <TMPL_ELSE>
    ...
    <table width="100%">
      ...
      <tr>
        <th>管理用パスワード (必須)</th><td><input type="text" name="pass" value="<TMPL_VAR admin_pass ESCAPE=html>" /><br />登録したタスクの設定を変更する場合に使用します。</td>
      </tr>
      <tr>
    ...
    <TMPL_ELSE>
      ...
      <p class="error">現在、デモのために新しいタスクの追加が無効になっています。現在タスク一覧に載っているタスクを利用して下さい。</p>
      <input type="button" value="タスク一覧に戻る" class="btn" onClick="location.href='webigator-demo.cgi'" />
